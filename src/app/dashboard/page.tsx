  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Main Content */}
        <Tabs
          defaultValue={isCreator ? "my-resources" : "my-purchases"}
          className="w-full"
        >
          ...
          <TabsContent value="my-purchases" className="mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Resources you have purchased</CardDescription>
              </CardHeader>
              <CardContent>
                      ...
                      >
                        ...
                        <div className="flex gap-2">
                          ...
                          {purchase.paymentStatus === "COMPLETED" && (
                            <Button size="sm" asChild>
                              <Link
                                href={`/resources/${purchase.resource.slug}?download=true`}
                              >
