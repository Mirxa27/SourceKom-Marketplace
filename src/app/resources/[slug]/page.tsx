...
export default function ResourceDetailPage() {
  ...
  useEffect(() => {
    // Fetch favorite status when user and resource are available
    if (user && resource) {
      fetchFavoriteStatus()
    }
  }, [user, resource])
    ...
    try {
      ...
      const response = await fetch('/api/purchases', {
        ...
        body: JSON.stringify({
          ...
          paymentMethod: 'myfatoorah' // Will be implemented with MyFatoorah
        })
      })
      ...
      <div className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-40">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <Link href="/browse" className="inline-flex items-center text-muted-foreground hover:text-foreground">
                  ...
                  <div className="space-y-2">
                    {isPurchased ? (
                      <div className="flex items-center gap-2 text-green-600">
                        ...
                        <span className="text-sm">You own this resource</span>
                      </div>
                    ) : (
                      <div className="space-y-2">
